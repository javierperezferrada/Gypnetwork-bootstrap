...
<html lang="es">
  ...
  <body>
    ...
    <div id="da-slider" class="da-slider">
            ...
            <div class="container">
              ...
              <h2>
                ...
                <i>CONFIGURACIÓN</i>
                <br>
                <i>CÁMARAS DE SEGURIDAD</i>
              </h2>
              <p>
                <i>Solo utilizamos productos de calidad.</i>
                <br />
                <i>Disponemos de cámaras de alta definición.</i>
              </p>
              <a href="#begin-message" class="btn btn-info btn-lg da-link">
                Leer más
              </a>
              <div class="da-img">
        ...
        <div class="row">
          <div class="col-md-12">
        <h2>
          <i>OBSERVA TODO EL TIEMPO</i>
            <br />
          <i>DESDE</i>
            <br />
          <i>TU TELÉFONO CELULAR</i>
        </h2>
        <p>
          <i>Solo necesitas de una conección a internet</i>
            <br />
        </p>
        <a href="#begin-message" class="btn btn-info btn-lg da-link">
          Leer más
      ...
      <div class="container">
        ...
        <p>
          <i>Comunica hasta 6 números diferentes</i>
           </br>
          <i>Sistema de alarma completamente inalámbrico</i>
          <br />
          <i>Con desbloqueo por control remoto y panel numerico.</i>
          <br />
        </p>
        <a href="#begin-message" class="btn btn-info btn-lg da-link">
          Leer más
    ...
    <div class="container" id="begin-message">
      <div class="row mar-b-50">
        <div class="col-md-12">
          <div class="text-center feature-head wow fadeInDown">
            <h1 class="">
              Bienvenidos a Gypnetwork Limitada
            </h1>
          ...
          <div class="feature-box">
            <div class="col-md-4 col-sm-4 text-center wow fadeInUp">
              ...
              <p class="text-center">
                Realizamos instalación y configuración.
              </p>
            </div>
            <div class="col-md-4 col-sm-4 text-center wow fadeInUp">
              <div class="feature-box-heading">
                ...
                <h4>
                  <b>Centrales de Alarma</b>
                </h4>
              </div>
              <p class="text-center">
                Solo necesitan de un chip prepago para realizar los avisos necesarios cuando se active.
              </p>
            </div>
            <div class="col-md-4 col-sm-4 text-center wow fadeInUp">
              <div class="feature-box-heading">
                ...
                <h4>
                  <b>Centrales Télefonicas</b>
                </h4>
              </div>
              <p class="text-center">
                Instalamos y configuramos todo tipo de centrales telefónicas para las pequeñas y medianas empresas.
              </p>
            </div>
          </div>
            ...
            <div class="panel-body">
                ...
                <div id="news" class="tab-pane fade in active">
                  <article class="media">
                    ...
                    <div class="media-body b-btm">
                      ...
                      <p>
                        Lo mejor en seguridad y calidad de video.
                      </p>
                    </div>
                  </article>
                  <article class="media">
                    ...
                    <div class="media-body b-btm">
                      ...
                      <p>
                        Central de alarma inteligente e inalámbrica.
                      </p>
                    </div>
                  </article>
                </div>
              ...
              -->
                <div id="comments" class="tab-pane fade">
                  <p>
                    Aún no hay comentarios regitrados.
                  </p>
                  <!--
                  <p>
                  ...
                  <li>
                    ...
                    <div class="about-testimonial-content">
                      <p class="about-testimonial-quote">
                        Encargado de hacer todas las programaciones de los equipos que instalamos.
                      </p>
                    </div>
                  </li>
                  <li>
                    ...
                    <div class="about-testimonial-content">
                      <p class="about-testimonial-quote">
                        Encargado de hacer todas las gestiones técnicas y de infraestructura en nuestros proyectos.
                      </p>
                    </div>
                  </li>
                </ul>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="h-service">
              ...
              <div class="h-service-content wow fadeInUp">
                ...
                <p>
                  Envienos sus datos con nuestro formulario de contacto y nosotros nos comunicaremos con usted.
                  <br>
          ...
          <div class="col-md-4">
            <div class="h-service">
              ...
              <div class="h-service-content wow fadeInUp">
                ...
                <p>
                  Tanto instalación como mantención de equipos 
                  de vigilancia como de comunicaciones
                  <br>
                </p>
              </div>
            </div>
          ...
          <div class="col-md-4">
            <div class="h-service">
              ...
              <div class="h-service-content wow fadeInUp">
                <h3>
                  Atiendase con nosotros
                </h3>
                <p>
                  EL mejor servicio, al mejor nivel
                  <br>
                </p>
              </div>
            </div>
